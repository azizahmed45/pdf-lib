...
var PDFSecurity = /** @class */ (function () {
    ...
    */
    PDFSecurity.generateFileID = function (info) {
        return wordArrayToBuffer(crypto_js_1.default.MD5(info.toString()));
    };
    PDFSecurity.generateRandomWordArray = function (bytes) {
        return crypto_js_1.default.lib.WordArray.random(bytes);
    };
    ...
    */
    ...
    PDFSecurity.prototype._setupEncryptionV5 = function (options) {
        ...
        var userKeySalt = crypto_js_1.default.lib.WordArray.create(userPasswordEntry.words.slice(10, 12), 8);
        ...
        var ownerKeySalt = crypto_js_1.default.lib.WordArray.create(ownerPasswordEntry.words.slice(10, 12), 8);
        ...
        if (this.version < 5) {
            ...
            if (this.version === 1 || this.version === 2) {
                ...
                return function (buffer) {
                    return wordArrayToBuffer(crypto_js_1.default.RC4.encrypt(crypto_js_1.default.lib.WordArray.create(buffer), key).ciphertext);
                };
            }
            if (this.version === 4) {
...
var getUserPasswordR2 = function (encryptionKey) {
    return crypto_js_1.default.RC4.encrypt(processPasswordR2R3R4(), encryptionKey).ciphertext;
};
var getUserPasswordR3R4 = function (documentId, encryptionKey) {
    var key = encryptionKey.clone();
    var cipher = crypto_js_1.default.MD5(processPasswordR2R3R4().concat(crypto_js_1.default.lib.WordArray.create(documentId)));
    for (var i = 0; i < 20; i++) {
...
var getUserEncryptionKeyR5 = function (processedUserPassword, userKeySalt, encryptionKey) {
    var key = crypto_js_1.default.SHA256(processedUserPassword.clone().concat(userKeySalt));
    var options = {
        mode: crypto_js_1.default.mode.CBC,
...
var getOwnerEncryptionKeyR5 = function (processedOwnerPassword, ownerKeySalt, userPasswordEntry, encryptionKey) {
    var key = crypto_js_1.default.SHA256(processedOwnerPassword
        .clone()
        .concat(ownerKeySalt)
        .concat(userPasswordEntry));
    var options = {
...
var getEncryptedPermissionsR5 = function (permissions, encryptionKey, generateRandomWordArray) {
    var cipher = crypto_js_1.default.lib.WordArray.create([lsbFirstWord(permissions), 0xffffffff, 0x54616462], 12).concat(generateRandomWordArray(4));
    var options = {
