...
var PDFSecurity_1 = tslib_1.__importDefault(require("../core/security/PDFSecurity"));
/**
...
var PDFDocument = /** @class */ (function () {
    ...
    PDFDocument.create = function (options) {
        if (options === void 0) { options = {}; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, updateMetadata, context, pageTree, pageTreeRef, catalog, pdfDoc;
            return tslib_1.__generator(this, function (_b) {
                ...
                pdfDoc = new PDFDocument(context, false, updateMetadata);
    ...
    PDFDocument.prototype.encrypt = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                newSecurity = this.context.obj(this._security.dictionary);
